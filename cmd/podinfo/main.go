...
import (
	...
	"github.com/jmatiascabrera/podinfo/pkg/api/grpc"
	"github.com/jmatiascabrera/podinfo/pkg/api/http"
	"github.com/jmatiascabrera/podinfo/pkg/signals"
...
func main() {
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/jmatiascabrera/podinfo/gh-pages/cuddle_clap.gif")
